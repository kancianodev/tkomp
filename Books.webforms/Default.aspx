        ...
        <div class="col-md-8 col-md-offset-2">
			...
			<ItemTemplate>
				<tr>
					...
					<td><asp:LinkButton ID="lkbEdit" runat="server" OnCommand="EditBook" CommandArgument='<%# Eval("BookId") %>' CssClass="btn btn-info"> E </asp:LinkButton></td>
					<td><asp:LinkButton ID="lkbDelete" runat="server" OnCommand="DeleteBook" CommandArgument='<%# Eval("BookId") %>' OnClientClick="return confirm('Are You sure to delete?')" CssClass="btn btn-danger"> X </asp:LinkButton></td>
				</tr>
			</ItemTemplate>
			<FooterTemplate>
			            </table>
